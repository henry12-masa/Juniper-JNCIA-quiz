...
const quizInfo = {
  nutanixNcp: { title: "Nutanix Certified Professional", desc: "AOS・Prism・AHV・ストレージ・クラスタ運用の基礎" },
  paloaltoPcnse: { title: "Palo Alto Networks Certified Network Security Engineer", desc: "PAN-OS・App-ID・Security Policy・Threat Prevention・ログ運用" },
  fortinetNse: { title: "Fortinet NSE", desc: "FortiGate・ポリシー・UTM・VPN・SD-WAN・ログ監視" },
  juniperJncia: { title: "Juniper JNCIA", desc: "Junos基礎・ルーティング・スイッチング・CLI・ネットワーク基礎" },
  juniperJncis: { title: "Juniper JNCIS", desc: "Junos中級・OSPF/BGP・フィルタ・HA・運用設計" }
};
...
if (type === "all") {
  document.title = "ネットワーク・仮想化資格クイズ";
  pageTitle.textContent = "ネットワーク・仮想化資格クイズ";
  pageDesc.textContent = "5カテゴリ・各150問から50問ランダムで出題";
} else {
  const info = quizInfo[type] || quizInfo.nutanixNcp;
